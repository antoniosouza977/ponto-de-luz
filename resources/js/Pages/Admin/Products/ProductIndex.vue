...
export default {
    ...
    components: {ProductStatus, EditButton, TrashIcon, IndexCRUD, Dashboard, Link, Paginator, ProducstFilter}
}
</script>
...
<template>
    <Dashboard>
        <IndexCRUD v-bind="$props">
            <ProducstFilter/>
            <span class="ml-3 text-green-700 p-1 font-bold text-gl">Total: {{ products.total }}</span>
                    ...
                    <div class="h-100  border rounded-lg border-green-200 shadow-xl">
                        ...
                        <div class="p-3 border-t">
                            ...
                            <Fieldset legend="Categorias">
                                <span class="d-inline-block border p-1 mr-1 rounded" v-for="category in product.categories">
                                    {{ category.name }}
                                </span>
                            </Fieldset>
