...
export default {
    ...
    components: {EditButton, TrashIcon, IndexCRUD, Dashboard, Link},
    methods: {
        statusLabel(status) {
            const status_label = {
                ...
                <div class="col-xl-4 col-lg-6 col-12 mb-3" v-for="product in products.data">
                    <div class="card h-100">
                        <div class="card-header p-0">
                            <div :id="'carousel' + product.id" class="carousel carousel-fade">
                        ...
                        <div class="card-body">
                            ...
                            <div class="border rounded p-2 mb-2">
                                ...
                                <span class="d-inline-block border p-1 mr-1 rounded" v-for="category in product.categories">{{category.name}}</span>
                            </div>
                            <div class="border rounded p-2 mb-2 d-flex flex-wrap">
                                ...
                                <div class="col-xl-4 col-gl-6 col-12 p-0">Estoque: {{product.stock_quantity}}</div>
                                <div class="col-xl-4 col-gl-6 col-12 p-0">Status: {{this.statusLabel(product.status)}}</div>
                            </div>
                        </div>
                        <div class="card-footer fs-4 d-flex justify-content-end align-items-center">
                            ...
                            <TrashIcon :btn="true" :model="product" :form-route="route('products.destroy', product)"></TrashIcon>
                        </div>
                    </div>
                </div>
